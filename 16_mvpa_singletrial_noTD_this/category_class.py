...
decoded = ('isfamous','ismanmade') #label for what's decoded?
resultdir = os.path.realpath(os.path.join(absolute_path,'..','mvpa_results/16_singletrial_noTD'))
print(resultdir)
...
for thisdur in durs:
    ...
    for thisdecode in decoded:
        print('...starting to decode: '+thisdecode)
        for mask in masks:
            print('......starting ROI: '+mask)

            accresultstr = thisdecode+'_dur'+str(thisdur)+'_'+mask
            ...
            for sbj in sbjs:
                ...
                evpredresultstr = 'sub-'+sbj+'_'+thisdecode+'_dur'+str(thisdur)+'_'+mask 
                ...
                expds.sa['targets'] = eval(thisdecode)
