...
rois=('b_ahip','b_phip','b_mofc','b_ifg','b_latpar','b_phg','b_it')
sbjs = ('301','302','304','305','307','308','309','310','311','312')
durs = ('1','4')
...
resultdir_all = basedir+'/scripts/rsa_results/20_rsa_singletrial_noTD/allruns_alltrials/'
mkdir_p(resultdir_all)
resultdir_allfame = basedir+'/scripts/rsa_results/20_rsa_singletrial_noTD/allruns_famous_only/'
mkdir_p(resultdir_allfame)
resultdir_allnfame = basedir+'/scripts/rsa_results/20_rsa_singletrial_noTD/allruns_nonfamous_only/'
mkdir_p(resultdir_allnfame)
resultdir_perception_all = basedir+'/scripts/rsa_results/20_rsa_singletrial_noTD/perceptionruns_alltrials/'
mkdir_p(resultdir_perception_all)
resultdir_recall_all = basedir+'/scripts/rsa_results/20_rsa_singletrial_noTD/recallruns_alltrials/'
mkdir_p(resultdir_recall_all)
resultdir_recall_fam = basedir+'/scripts/rsa_results/20_rsa_singletrial_noTD/recallruns_famous_only/'
